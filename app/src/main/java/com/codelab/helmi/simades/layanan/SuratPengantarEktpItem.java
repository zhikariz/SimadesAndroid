...
public class SuratPengantarEktpItem{
	...
	public void setKetPermohonan(String ketPermohonan){
		this.ketPermohonan = ketPermohonan;
	}

	public String getKetPermohonan(){
		return ketPermohonan;
	}
