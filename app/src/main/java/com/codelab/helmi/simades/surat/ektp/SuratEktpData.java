...
public class SuratEktpData implements Parcelable {
    ...
    @SerializedName("nik")
    private String nik;
    @SerializedName("ket_permohonan")
    private String ket_permohonan;
    ...
    public String getKet_permohonan() {
        return ket_permohonan;
    }

    public void setKet_permohonan(String ket_permohonan) {
        this.ket_permohonan = ket_permohonan;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.ket_permohonan);
    ...
    public SuratEktpData() {
    }

    protected SuratEktpData(Parcel in) {
        ...
        this.ket_permohonan = in.readString();
    ...
    public static final Parcelable.Creator<SuratEktpData> CREATOR = new Parcelable.Creator<SuratEktpData>() {
        @Override
        public SuratEktpData createFromParcel(Parcel source) {
            return new SuratEktpData(source);
        }

        @Override
        public SuratEktpData[] newArray(int size) {
            return new SuratEktpData[size];
        }
    };
}
