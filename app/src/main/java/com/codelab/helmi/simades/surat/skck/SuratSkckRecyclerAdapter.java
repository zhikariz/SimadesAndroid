...
public class SuratSkckRecyclerAdapter extends RecyclerView.Adapter<SuratSkckRecyclerAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                suratSkckData.setKd_surat(mList.get(position).getKd_surat());
                suratSkckData.setNo_surat(mList.get(position).getNo_surat());
                suratSkckData.setTgl_surat(mList.get(position).getTgl_surat());

                suratSkckData.setStatus_persetujuan(mList.get(position).getStatus_persetujuan());
                suratSkckData.setNik(mList.get(position).getNik());
                suratSkckData.setNama_depan(mList.get(position).getNama_depan());
                suratSkckData.setNama_belakang(mList.get(position).getNama_belakang());
                suratSkckData.setNama_depan_user(mList.get(position).getNama_depan_user());
                suratSkckData.setNama_belakang_user(mList.get(position).getNama_belakang_user());
