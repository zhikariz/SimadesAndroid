...
public class SuratKehilanganData implements Parcelable {
    ...
    private String tgl_hilang;
    @SerializedName("tpt_hilang")
    private String tpt_hilang;
    ...
    public String getTgl_hilang() {
        return tgl_hilang;
    }

    public void setTgl_hilang(String tgl_hilang) {
        this.tgl_hilang = tgl_hilang;
    }

    public String getTpt_hilang() {
        return tpt_hilang;
    }

    public void setTpt_hilang(String tpt_hilang) {
        this.tpt_hilang = tpt_hilang;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.tgl_hilang);
        dest.writeString(this.tpt_hilang);
    ...
    public SuratKehilanganData() {
    }

    protected SuratKehilanganData(Parcel in) {
        ...
        this.tgl_hilang = in.readString();
        this.tpt_hilang = in.readString();
    ...
    public static final Parcelable.Creator<SuratKehilanganData> CREATOR = new Parcelable.Creator<SuratKehilanganData>() {
        @Override
        public SuratKehilanganData createFromParcel(Parcel source) {
            return new SuratKehilanganData(source);
        }

        @Override
        public SuratKehilanganData[] newArray(int size) {
            return new SuratKehilanganData[size];
        }
    };
}
