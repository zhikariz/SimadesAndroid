...
public class SuratSkckData implements Parcelable {
    ...
    public SuratSkckData() {
    }

    protected SuratSkckData(Parcel in) {
    ...
    public static final Parcelable.Creator<SuratSkckData> CREATOR = new Parcelable.Creator<SuratSkckData>() {
        @Override
        public SuratSkckData createFromParcel(Parcel source) {
            return new SuratSkckData(source);
        }

        @Override
        public SuratSkckData[] newArray(int size) {
            return new SuratSkckData[size];
        }
    };
}
