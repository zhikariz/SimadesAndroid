 ...
 */
public class SuratBlmMenikahFragment extends Fragment implements SuratBlmMenikahView, SwipeRefreshLayout.OnRefreshListener, SearchView.OnQueryTextListener, View.OnClickListener {
    View view;
    private RecyclerView mRecycler;
    SuratBlmMenikahRecyclerAdapter mAdapter;
    ...
    public void initPresenter() {
        presenter = new SuratBlmMenikahPresenter(getActivity());
    }
    ...
    @Override
    public void setAdapter(List<SuratBlmMenikahData> suratBlmMenikahData) {
        mAdapter = new SuratBlmMenikahRecyclerAdapter(getActivity(), suratBlmMenikahData, getFragmentManager());
