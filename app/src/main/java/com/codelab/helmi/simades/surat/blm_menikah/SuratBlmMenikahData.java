...
public class SuratBlmMenikahData implements Parcelable {
    ...
    public SuratBlmMenikahData() {
    }

    protected SuratBlmMenikahData(Parcel in) {
    ...
    public static final Parcelable.Creator<SuratBlmMenikahData> CREATOR = new Parcelable.Creator<SuratBlmMenikahData>() {
        @Override
        public SuratBlmMenikahData createFromParcel(Parcel source) {
            return new SuratBlmMenikahData(source);
        }

        @Override
        public SuratBlmMenikahData[] newArray(int size) {
            return new SuratBlmMenikahData[size];
        }
    };
}
