...
public class SuratKeramaianData implements Parcelable {
    ...
    public SuratKeramaianData() {
    }

    protected SuratKeramaianData(Parcel in) {
    ...
    public static final Parcelable.Creator<SuratKeramaianData> CREATOR = new Parcelable.Creator<SuratKeramaianData>() {
        @Override
        public SuratKeramaianData createFromParcel(Parcel source) {
            return new SuratKeramaianData(source);
        }

        @Override
        public SuratKeramaianData[] newArray(int size) {
            return new SuratKeramaianData[size];
        }
    };
}
