...
public class SuratDomisiliData implements Parcelable {
    ...
    public SuratDomisiliData() {
    }

    protected SuratDomisiliData(Parcel in) {
    ...
    public static final Parcelable.Creator<SuratDomisiliData> CREATOR = new Parcelable.Creator<SuratDomisiliData>() {
        @Override
        public SuratDomisiliData createFromParcel(Parcel source) {
            return new SuratDomisiliData(source);
        }

        @Override
        public SuratDomisiliData[] newArray(int size) {
            return new SuratDomisiliData[size];
        }
    };
}
