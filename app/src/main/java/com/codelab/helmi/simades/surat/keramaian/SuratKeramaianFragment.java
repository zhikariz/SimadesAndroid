 ...
 */
public class SuratKeramaianFragment extends Fragment implements SuratKeramaianView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initPresenter() {
        presenter = new SuratKeramaianPresenter(mAdapter);
    }
